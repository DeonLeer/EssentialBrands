  ...
  return (
    <div className="TerpenesLearn">
      ...
      <div className="TerpenesContent">
        ...
        <div className="TerpenesLearnText"><p>Terpenes are the aromatic essential oils found in varying concentrations in the flowers, fruit, stems and leaves of all plants. Plants use terpenes to protect against herbivores and attract pollinators. In cannabis, terpenes are responsible for giving strain specific scent, flavour and contributing to the entourage effect. Terpenes powerfully affect the way cannabis reacts with our endocannabinoid system, so understanding them and how they function is important.</p>
        <p>Two cannabis plants could have the exact same cannabinoid profiles, but the terpene structure could be completely different – and that would result in two very different psychoactive experiences, i.e. Sativa and Indica.</p>
        <p>There are more than 20,000 known terpenes in nature, about 100 that are known to exist in cannabis and hemp and of these approximately 20 that are commonly found and 11 which are usually found and are considered primary.
        Commercially, individual food grade terpenes are extracted from non cannabis plants for use in food, beverage and industrial production and are available for flavoring cannabis concentrates.</p></div>
      </div>
